...
Indicated the IPv6 packet’s class or priority. Similar to the IPv4 Type of Service field.
...
Indicated that this packet belongs to a specific sequence of packets

(Originally created for giving real-time applications special service ,to ensure that they will not be reordered.)
